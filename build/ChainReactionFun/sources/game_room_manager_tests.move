...
module chain_reaction_fun::game_room_manager_tests {
    ...
    public fun test_create_room_min_player( aptos_framework: &signer, chain_reaction: &signer, player1: &signer, player2: &signer) {
    ...
    public fun test_join_full_room( aptos_framework: &signer, chain_reaction: &signer, player1: &signer, player2: &signer) {
    ...
    #[test(aptos_framework = @aptos_framework, chain_reaction = @chain_reaction_fun, player1 = @PLAYER1, player2 = @PLAYER2)]
    public fun test_leave_room( aptos_framework: &signer, chain_reaction: &signer, player1: &signer, player2: &signer) {
    ...
    #[test(aptos_framework = @aptos_framework, chain_reaction = @chain_reaction_fun, player1 = @PLAYER1, player2 = @PLAYER2)]
    public fun test_distribute_winnings_with_fee( aptos_framework: &signer, chain_reaction: &signer, player1: &signer, player2: &signer) {
        ...
        assert!(coin::balance<AptosCoin>(@chain_reaction_fun) == 1020, E_UNEXPECTED_BALANCE);
    }
